...
export default function HommiePaymentModal({ isOpen, onClose, booking, onPaymentSuccess }) {
  ...
  const handlePay = () => {
    ...
    window.setTimeout(() => {
      processBookingPayment(booking.id, { method, upiApp: null, status: method === 'cash' ? 'pending_confirmation' : 'paid' });
      ...
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200">
        ...
        {paymentDone ? (
          ...
          <div className="mt-5 space-y-5">
            ...
            <div><label className="text-xs font-bold uppercase tracking-wider text-slate-400 block mb-2">Choose payment method</label><div className="grid grid-cols-2 gap-2">
